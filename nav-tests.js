...
console.log("\n--- ⭐ every level-3 screen is now a real destination ---");
{
  ...
  eq("all thirteen finance screens are registered (Job history + Transactions added 2026-09-15)", fin.length, 13);
  ok("📜 Job history among them", fin.some(d => d.sub === "history"));
  ok("🏦 Transactions among them", fin.some(d => d.sub === "bank"));
