...
const qs = [{ id: "q1", q: "Who is Jason in the app?" }, { id: "q2", q: "Answered one", answer: "yes" }, { id: "q3", q: "Later", askAfter: "2026-09-17" }];
...
ok("only unanswered questions, and not one dated for a later day", a.questions.length === 1 && a.questions[0].id === "q1", a.questions);
ok("a dated follow-up appears once its day arrives", su.standupAgenda("2026-09-17", [], [], qs, {}).questions.map(q => q.id).join() === "q1,q3");
