...
function rcptTableHTML(rows, dups) {
  ...
  rows.slice(0, 500).forEach(r => {
    ...
    const splitBtn = (typeof rcptRowSplit === "function" && (+r.amount > 0)) ? `<button class="btn ghost sm" style="margin-top:5px;white-space:nowrap" onclick="event.stopPropagation();rcptRowSplit('${r.store}','${r.jobId || ""}','${r.recId}')" title="Split this receipt into parts">🔀 Split</button>` : "";
