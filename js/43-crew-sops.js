...
const CREW_SOPS=[
 ...
 {id:"04",name:"Junk Removal / Clear-Outs",tier:"SPINE",crew:"2",svc:["junk"],
  ...
  checklist:["Walk full scope, confirm what's going","Protect floors/walls on the carry-out","Set aside + log resale items (never take unauthorized)","Separate clean veg from C&D","Price the dump fee IN — EVERY pound counts: ~$73.16/ton mixed C&D, ~$58/ton veg. Nothing is free for us; the free allowances are residential","Sweep the cleared space; before/after photos","Invoice through the app + drop the review link"]},
 ...
 {id:"07",name:"Small Shed Demo",tier:"SECONDARY",crew:"2",svc:["demo"],
  ...
  aids:["Confirm utilities DISCONNECTED before touching it","Check age/materials — suspect siding/roofing → asbestos/lead risk → stop","C&D debris pays tonnage (~$73.16/ton) — price it in, this is NOT free veg","Call 811 if any digging near the pad"],
