...
const JUNK_FEE={freon:10,mattress:25,tire:8,ewaste:30,paint:10,appliance:25}; // freon 45->10 (2026-09-16): NC White Goods Disposal Tax ($3 at retail) funds COUNTY freon recovery — Dare transfer stations take fridges as white goods at the normal $65/ton prorated rate (~$7/fridge), no EPA tech needed. The $10 is a handling premium, not a recovery cost. The old $45x2 helped price a 2-fridge curb grab at $330 vs the ~$200 market; job lost.
...
function wizJunkUI(){
  ...
  if(c.counts.freon)h+=`<div class="card" style="border-left:4px solid var(--warn,#c90);font-size:12.5px;line-height:1.5">❄️ ${c.counts.freon} Freon unit(s): Dare County transfer stations take these as white goods — the county recovers the refrigerant (funded by NC’s $3 white-goods tax), billed at the normal $65/ton prorated rate. No EPA tech needed; keep them upright and undamaged so the sealed system stays intact.</div>`;
...
window.wizAddJunk=function(){
  ...
  if(c.counts.freon)notes.push(c.counts.freon+" Freon unit(s) — white goods at the county transfer station (county recovers refrigerant; keep sealed systems intact).");
