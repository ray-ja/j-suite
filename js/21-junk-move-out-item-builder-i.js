...
const JUNK_FEE={freon:25,mattress:25,tire:8,ewaste:30,paint:10,appliance:25}; // freon 45->25 (2026-09-16): fridges/freezers/ACs cannot go to Soundside; they ride to Dare's Manns Harbor transfer station as WHITE GOODS, where the COUNTY recovers the refrigerant (funded by NC's $3 white-goods tax) — no EPA tech on our side. COMMERCIAL rate there is $75.35/ton prorated with NO free allowance (the 500 lb waiver is residential — see CLAUDE.md), so ~$8 a fridge in tipping plus a share of the longer Manns Harbor run: $25 a unit. The old $45x2 plus the full site drive priced a 2-fridge curb grab at $425 against a ~$200 market; job lost. Original note: NC White Goods Disposal Tax ($3 at retail) funds COUNTY freon recovery — Dare transfer stations take fridges as white goods at the normal $65/ton prorated rate (~$7/fridge), no EPA tech needed. The $10 is a handling premium, not a recovery cost. The old $45x2 helped price a 2-fridge curb grab at $330 vs the ~$200 market; job lost.
...
function wizJunkUI(){
  ...
  if(c.counts.freon)h+=`<div class="card" style="border-left:4px solid var(--warn,#c90);font-size:12.5px;line-height:1.5">❄️ ${c.counts.freon} Freon unit(s): these go to Dare County's Manns Harbor transfer station as white goods (not Soundside). The county recovers the refrigerant, funded by NC's white-goods tax, so no EPA tech is needed on our side; commercial tipping is $75.35/ton prorated with no free allowance. Keep them upright and undamaged so the sealed system stays intact. The $25 a unit in the price covers tipping plus the longer run.</div>`;
...
window.wizAddJunk=function(){
  ...
  if(c.counts.freon)notes.push(c.counts.freon+" Freon unit(s) — white goods at Dare County's Manns Harbor transfer station (county recovers the refrigerant; keep sealed systems intact; $25/unit covers tipping + the run).");
