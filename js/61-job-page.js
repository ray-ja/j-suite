...
const JOB_LAYOUT_KEYS_DEFAULT = ["guide", "xquote", "data", "partof", "change", "askcap", "crew", "vehicles", "clock", "load", "costs", "matreport", "photos", "notes", "invoice", "closeout", "workdays", "done"];
...
const JOB_TABS = [
  { key: "overview", label: "📋 Overview", secs: ["guide", "xquote", "data", "change", "crew", "vehicles", "partof"] },
...
function rJobPage(j) {
  ...
  const _sections = [
    ...
    /* Phase 4 (2026-09-22): a quote billed from another org, shown here so one project reads as one page (js/189) */
    { key: "xquote", label: "🔗 Linked quote", html: (typeof jobLinkedQuoteHTML === "function") ? jobLinkedQuoteHTML(j) : "" },
