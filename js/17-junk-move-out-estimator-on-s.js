...
window.saveJunkQuote=function(){
  ...
  const q={id:uid(),customerId:null,cust:nm,propertyId:null,address:"",date:today(),items:[{serviceId:"",name:"Junk / move-out removal",unit:"job",price:total,qty:1,bandKey:"junk"}],recurring:false,subtotal:total,discount:0,total:total,kind:"junk",notes:notes,updatedAt:now()};
