...
const ROUTE_TABS=["today","accounts","quotes","jobs","leads","schedule","messages","map","route","routes","todo","plan","training","market","opps","sites","buildplan","inventory","resale","time","pay","finance","receipts","data","approvals","admin","playbook","research","escape","booking","life","budget","team"];
...
const NAV_GROUPS = [
  ...
  { key:"sales",     label:"Sales",     icon:"💼", tabs:["leads","quotes"] },
...
const TAB_META = {
  today:{l:"Today",i:"🧭"}, leads:{l:"Leads",i:"📞"}, quotes:{l:"Quotes",i:"🧾"}, jobs:{l:"Jobs",i:"🧾"}, booking:{l:"Booking",i:"🎟️"}, schedule:{l:"Schedule",i:"📅"}, time:{l:"Time",i:"⏱️"}, map:{l:"Map",i:"🗺️"},
  ...
  todo:{l:"To-Do",i:"✅"}, inventory:{l:"Inventory",i:"🧰"}, resale:{l:"Resale",i:"♻️"}, data:{l:"Data",i:"⚙️"}, admin:{l:"Admin",i:"🛡️"}, playbook:{l:"Playbook",i:"📒"}, research:{l:"Research",i:"📚"}, escape:{l:"Rooms",i:"🚪"}, life:{l:"Life",i:"🌱"}, budget:{l:"Budget",i:"💵"}, team:{l:"Team",i:"🧑‍🤝‍🧑"}, routes:{l:"Routes",i:"🗺️"}
};
