...
const NAV_GROUPS = [
  ...
  { key:"workout",   label:"Workout",   icon:"🏋️", tabs:["workout"] },
  ...
  // STUDIO — footage waiting to be cut for TikTok/X. Deliberately NOT opt-in, so it appears on the work orgs
  // (Jamieson, the escape room, OBX) that run on the full default, and deliberately absent from the personal
...
const ORG_OPTIN_TABS = ["escape","booking","life","journal","shelf","workout","cal","budget"];
const ORG_TEMPLATES = {
  ...
  personal: ["life","journal","shelf","workout","cal","budget","todo","messages"]
};
