...
window.wizSetSvc=function(k){if(k==="demo"){openDemoEst();return;}if(k==="parking"){WZON=false;TAB="map";if(typeof render==="function")render();return;}WZ.svc=k;WZ.inp={};WZ.deepSearch="";render2calc();};
