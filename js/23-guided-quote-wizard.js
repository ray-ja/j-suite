...
const WZ_FIELDS={
 ...
 housewatch:[{k:"size",t:"sel",label:"Home size",opts:[["small","Up to 4 bedrooms"],["medium","5–8 bedrooms"],["large","9+ / estate"]]},{k:"freq",t:"sel",label:"Frequency",opts:[["monthly","Monthly"],["bi-weekly","Bi-weekly"],["weekly","Weekly"]]},{k:"miles",t:"num",label:"Miles from Harbinger, one-way",ph:"first 25 are standard rate"},{k:"access",t:"sel",label:"Access",opts:[["","Road"],["carova","Carova (beach)"],["ocracoke","Ocracoke (ferry)"]]}],
