...
console.log("\n— Disposal helper ($73.16/ton, first 500 lbs free) —");
ok("500 lbs (all free) = $0",           L.disposalCost(500) === 0, L.disposalCost(500));
ok("400 lbs (under free) = $0",         L.disposalCost(400) === 0, L.disposalCost(400));
ok("2000 lbs = 0.75 ton billable = $54.87", near(L.disposalCost(2000), 54.87), L.disposalCost(2000));
ok("2500 lbs = 1.00 ton billable = $73.16", near(L.disposalCost(2500), 73.16), L.disposalCost(2500));
ok("4500 lbs = 2.00 ton billable = $146.32", near(L.disposalCost(4500), 146.32), L.disposalCost(4500));
ok("typical pickup load 1500 lbs = $36.58", near(L.disposalCost(1500), 36.58), L.disposalCost(1500));
...
ok("junk explicit lbs overrides eighths",   near(L.calcCost("junk",{lbs:2500},{obx:L.COST_DEFAULT.obx}), 25 + 73.16, 0.5), L.calcCost("junk",{lbs:2500},{obx:L.COST_DEFAULT.obx}));
...
ok("disposal line cost = $54.87",       near(dl.cost, 54.87), dl.cost);
