...
console.log("\n— Disposal helper ($90/ton at the close station, EVERY pound billable — the 500 lb waiver is annual + residential) —");
ok("⛔ 500 lbs is NOT free — $22.50", near(L.disposalCost(500), 22.50), L.disposalCost(500));
ok("⛔ 400 lbs is NOT free — $18.00 (no residential waiver in a quote)", near(L.disposalCost(400), 18.00), L.disposalCost(400));
ok("2000 lbs = 1.00 ton = $90.00", near(L.disposalCost(2000), 90.00), L.disposalCost(2000));
ok("4000 lbs = 2.00 ton = $180.00", near(L.disposalCost(4000), 180.00), L.disposalCost(4000));
ok("typical pickup load 1500 lbs = $67.50", near(L.disposalCost(1500), 67.50), L.disposalCost(1500));
...
ok("junk explicit lbs overrides eighths",   near(L.calcCost("junk",{lbs:2500},{obx:L.COST_DEFAULT.obx}), 25 + L.disposalCost(2500), 0.5), L.calcCost("junk",{lbs:2500},{obx:L.COST_DEFAULT.obx}));
...
ok("disposal line cost = $90.00 (the whole 2,000 lb)", near(dl.cost, 90.00), dl.cost);
