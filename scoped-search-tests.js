...
function setData(cs, ps, qs, js) { var d = D(); d.customers = cs; d.properties = ps; d.quotes = qs; d.jobs = js || []; }
...
// q2 is accepted with a LIVE job j2 → its Jobs-table row routes to the unified job page (openJobPage); q1/q3 have
// no live job → they stay on openQuote. This makes the q_many golden the proof of the Phase-3 accepted→job routing.
var Jmany = [{ id: "j2", quoteId: "q2", title: "Beta paver", updatedAt: 1 }];

// ---- PRE-CHANGE GOLDEN: the exact #view innerHTML each render produced BEFORE the scoped-search refactor ----
var GOLDEN = {"q_empty":"<h2>Jobs</h2><div class=\"row\" style=\"gap:8px;margin-bottom:10px\"><button class=\"btn acc grow\" onclick=\"startWizard()\">✨ Guided Quote</button><button class=\"btn ghost grow\" onclick=\"if(typeof navSub==='function')navSub('leads')\">📞 Guided Lead</button></div><div id=\"qlist\"><div class=\"empty\"><div class=\"big\">🧾</div>No jobs yet.<br>Use Guided Quote above, or tap + for the quick builder.</div></div>","q_one":"<h2>Jobs</h2><div class=\"row\" style=\"gap:8px;margin-bottom:10px\"><button class=\"btn acc grow\" onclick=\"startWizard()\">✨ Guided Quote</button><button class=\"btn ghost grow\" onclick=\"if(typeof navSub==='function')navSub('leads')\">📞 Guided Lead</button></div><input class=\"search\" id=\"qsearch\" placeholder=\"Search jobs (customer, type, date)…\" value=\"\" oninput=\"qSearchOn(this.value)\"><div class=\"subnav\" style=\"margin:8px 0\"><button class=\"subbtn on\" onclick=\"quoteFilter('all')\">All</button><button class=\"subbtn \" onclick=\"quoteFilter('quote')\">Quote</button><button class=\"subbtn \" onclick=\"quoteFilter('job')\">Job</button><button class=\"subbtn \" onclick=\"quoteFilter('expense')\">Expense</button><button class=\"subbtn \" onclick=\"quoteFilter('invoice')\">Invoice</button><button class=\"subbtn \" onclick=\"quoteFilter('paid')\">Paid</button></div><button class=\"btn acc sm\" style=\"margin-bottom:10px\" onclick=\"qToggleHideDone()\">✅ Hiding 0 finished</button><select onchange=\"quoteCrewFilter(this.value)\" style=\"font-size:13px;margin-bottom:10px\"><option value=\"\" selected=\"\">👥 All crew</option><option value=\"u_g\">G</option></select><details class=\"card\" style=\"margin-bottom:10px\"><summary style=\"cursor:pointer;font-weight:700;user-select:none\">⚙️ Date range</summary><div class=\"row\" style=\"gap:8px;margin-top:8px\"><div class=\"grow\"><label>From</label><input type=\"date\" value=\"\" onchange=\"qDateFrom(this.value)\" style=\"width:100%\"></div><div class=\"grow\"><label>To</label><input type=\"date\" value=\"\" onchange=\"qDateTo(this.value)\" style=\"width:100%\"></div></div></details><div id=\"qlist\"><div class=\"row\" style=\"gap:8px;align-items:center;margin-bottom:8px\"><span class=\"sub\" style=\"white-space:nowrap\">⇅ Sort</span><select aria-label=\"Sort jobs\" onchange=\"qSetSort(this.value)\" style=\"font-size:13px;flex:1\"><option value=\"date\" selected=\"\">Date</option><option value=\"customer\">Customer</option><option value=\"type\">Type</option><option value=\"status\">Status</option><option value=\"expenses\">Expenses</option><option value=\"price\">Price</option></select><button class=\"btn ghost sm\" aria-label=\"Toggle sort direction\" onclick=\"qSetSort('date')\" style=\"white-space:nowrap\">▼</button><span class=\"sub\" style=\"white-space:nowrap\">1</span></div><div class=\"card\" style=\"padding:0;overflow:hidden\"><div onclick=\"openQuote('q1')\" style=\"display:flex;gap:10px;padding:11px 12px;border-left:4px solid #97a0ad;border-bottom:1px solid var(--line);cursor:pointer\"><div style=\"flex:1;min-width:0\"><div style=\"display:flex;gap:8px;justify-content:space-between;align-items:baseline\"><div style=\"flex:1;min-width:0;font-size:15px;font-weight:700;line-height:1.25\">Junk</div><div style=\"text-align:right;white-space:nowrap;font-size:15px;font-weight:800;color:var(--brand-text)\">$100</div></div><div style=\"font-size:12.5px;color:var(--muted);margin-top:3px\">Alpha · 06/01/26 · <span style=\"color:#97a0ad;font-weight:700\">Quote</span></div></div></div></div></div>","q_many":"<h2>Jobs</h2><div class=\"row\" style=\"gap:8px;margin-bottom:10px\"><button class=\"btn acc grow\" onclick=\"startWizard()\">✨ Guided Quote</button><button class=\"btn ghost grow\" onclick=\"if(typeof navSub==='function')navSub('leads')\">📞 Guided Lead</button></div><input class=\"search\" id=\"qsearch\" placeholder=\"Search jobs (customer, type, date)…\" value=\"\" oninput=\"qSearchOn(this.value)\"><div class=\"subnav\" style=\"margin:8px 0\"><button class=\"subbtn on\" onclick=\"quoteFilter('all')\">All</button><button class=\"subbtn \" onclick=\"quoteFilter('quote')\">Quote</button><button class=\"subbtn \" onclick=\"quoteFilter('job')\">Job</button><button class=\"subbtn \" onclick=\"quoteFilter('expense')\">Expense</button><button class=\"subbtn \" onclick=\"quoteFilter('invoice')\">Invoice</button><button class=\"subbtn \" onclick=\"quoteFilter('paid')\">Paid</button></div><button class=\"btn acc sm\" style=\"margin-bottom:10px\" onclick=\"qToggleHideDone()\">✅ Hiding 0 finished</button><select onchange=\"quoteCrewFilter(this.value)\" style=\"font-size:13px;margin-bottom:10px\"><option value=\"\" selected=\"\">👥 All crew</option><option value=\"u_g\">G</option></select><details class=\"card\" style=\"margin-bottom:10px\"><summary style=\"cursor:pointer;font-weight:700;user-select:none\">⚙️ Date range</summary><div class=\"row\" style=\"gap:8px;margin-top:8px\"><div class=\"grow\"><label>From</label><input type=\"date\" value=\"\" onchange=\"qDateFrom(this.value)\" style=\"width:100%\"></div><div class=\"grow\"><label>To</label><input type=\"date\" value=\"\" onchange=\"qDateTo(this.value)\" style=\"width:100%\"></div></div></details><div id=\"qlist\"><div class=\"row\" style=\"gap:8px;align-items:center;margin-bottom:8px\"><span class=\"sub\" style=\"white-space:nowrap\">⇅ Sort</span><select aria-label=\"Sort jobs\" onchange=\"qSetSort(this.value)\" style=\"font-size:13px;flex:1\"><option value=\"date\" selected=\"\">Date</option><option value=\"customer\">Customer</option><option value=\"type\">Type</option><option value=\"status\">Status</option><option value=\"expenses\">Expenses</option><option value=\"price\">Price</option></select><button class=\"btn ghost sm\" aria-label=\"Toggle sort direction\" onclick=\"qSetSort('date')\" style=\"white-space:nowrap\">▼</button><span class=\"sub\" style=\"white-space:nowrap\">3</span></div><div class=\"card\" style=\"padding:0;overflow:hidden\"><div onclick=\"openJobPage('j2')\" style=\"display:flex;gap:10px;padding:11px 12px;border-left:4px solid #2f6fed;border-bottom:1px solid var(--line);cursor:pointer\"><div style=\"flex:1;min-width:0\"><div style=\"display:flex;gap:8px;justify-content:space-between;align-items:baseline\"><div style=\"flex:1;min-width:0;font-size:15px;font-weight:700;line-height:1.25\">Paver</div><div style=\"text-align:right;white-space:nowrap;font-size:15px;font-weight:800;color:var(--brand-text)\">$200</div></div><div style=\"font-size:12.5px;color:var(--muted);margin-top:3px\">Beta · 06/05/26 · <span style=\"color:#2f6fed;font-weight:700\">Job</span></div></div></div><div onclick=\"openQuote('q1')\" style=\"display:flex;gap:10px;padding:11px 12px;border-left:4px solid #97a0ad;border-bottom:1px solid var(--line);cursor:pointer\"><div style=\"flex:1;min-width:0\"><div style=\"display:flex;gap:8px;justify-content:space-between;align-items:baseline\"><div style=\"flex:1;min-width:0;font-size:15px;font-weight:700;line-height:1.25\">Junk</div><div style=\"text-align:right;white-space:nowrap;font-size:15px;font-weight:800;color:var(--brand-text)\">$100</div></div><div style=\"font-size:12.5px;color:var(--muted);margin-top:3px\">Alpha · 06/01/26 · <span style=\"color:#97a0ad;font-weight:700\">Quote</span></div></div></div><div onclick=\"openQuote('q3')\" style=\"display:flex;gap:10px;padding:11px 12px;border-left:4px solid #1a7f37;border-bottom:1px solid var(--line);cursor:pointer\"><div style=\"flex:1;min-width:0\"><div style=\"display:flex;gap:8px;justify-content:space-between;align-items:baseline\"><div style=\"flex:1;min-width:0;font-size:15px;font-weight:700;line-height:1.25\">Cleanup</div><div style=\"text-align:right;white-space:nowrap;font-size:15px;font-weight:800;color:#1a7f37\">$50</div></div><div style=\"font-size:12.5px;color:var(--muted);margin-top:3px\">Gamma · 05/20/26 · <span style=\"color:#1a7f37;font-weight:700\">Paid</span> <button class=\"btn acc sm\" onclick=\"event.stopPropagation();plReview('q3')\">Review →</button></div></div></div></div></div>","q_search":"<h2>Jobs</h2><div class=\"row\" style=\"gap:8px;margin-bottom:10px\"><button class=\"btn acc grow\" onclick=\"startWizard()\">✨ Guided Quote</button><button class=\"btn ghost grow\" onclick=\"if(typeof navSub==='function')navSub('leads')\">📞 Guided Lead</button></div><input class=\"search\" id=\"qsearch\" placeholder=\"Search jobs (customer, type, date)…\" value=\"alpha\" oninput=\"qSearchOn(this.value)\"><div class=\"subnav\" style=\"margin:8px 0\"><button class=\"subbtn on\" onclick=\"quoteFilter('all')\">All</button><button class=\"subbtn \" onclick=\"quoteFilter('quote')\">Quote</button><button class=\"subbtn \" onclick=\"quoteFilter('job')\">Job</button><button class=\"subbtn \" onclick=\"quoteFilter('expense')\">Expense</button><button class=\"subbtn \" onclick=\"quoteFilter('invoice')\">Invoice</button><button class=\"subbtn \" onclick=\"quoteFilter('paid')\">Paid</button></div><button class=\"btn acc sm\" style=\"margin-bottom:10px\" onclick=\"qToggleHideDone()\">✅ Hiding 0 finished</button><select onchange=\"quoteCrewFilter(this.value)\" style=\"font-size:13px;margin-bottom:10px\"><option value=\"\" selected=\"\">👥 All crew</option><option value=\"u_g\">G</option></select><details class=\"card\" style=\"margin-bottom:10px\"><summary style=\"cursor:pointer;font-weight:700;user-select:none\">⚙️ Date range</summary><div class=\"row\" style=\"gap:8px;margin-top:8px\"><div class=\"grow\"><label>From</label><input type=\"date\" value=\"\" onchange=\"qDateFrom(this.value)\" style=\"width:100%\"></div><div class=\"grow\"><label>To</label><input type=\"date\" value=\"\" onchange=\"qDateTo(this.value)\" style=\"width:100%\"></div></div></details><div id=\"qlist\"><div class=\"row\" style=\"gap:8px;align-items:center;margin-bottom:8px\"><span class=\"sub\" style=\"white-space:nowrap\">⇅ Sort</span><select aria-label=\"Sort jobs\" onchange=\"qSetSort(this.value)\" style=\"font-size:13px;flex:1\"><option value=\"date\" selected=\"\">Date</option><option value=\"customer\">Customer</option><option value=\"type\">Type</option><option value=\"status\">Status</option><option value=\"expenses\">Expenses</option><option value=\"price\">Price</option></select><button class=\"btn ghost sm\" aria-label=\"Toggle sort direction\" onclick=\"qSetSort('date')\" style=\"white-space:nowrap\">▼</button><span class=\"sub\" style=\"white-space:nowrap\">1</span></div><div class=\"card\" style=\"padding:0;overflow:hidden\"><div onclick=\"openQuote('q1')\" style=\"display:flex;gap:10px;padding:11px 12px;border-left:4px solid #97a0ad;border-bottom:1px solid var(--line);cursor:pointer\"><div style=\"flex:1;min-width:0\"><div style=\"display:flex;gap:8px;justify-content:space-between;align-items:baseline\"><div style=\"flex:1;min-width:0;font-size:15px;font-weight:700;line-height:1.25\">Junk</div><div style=\"text-align:right;white-space:nowrap;font-size:15px;font-weight:800;color:var(--brand-text)\">$100</div></div><div style=\"font-size:12.5px;color:var(--muted);margin-top:3px\">Alpha · 06/01/26 · <span style=\"color:#97a0ad;font-weight:700\">Quote</span></div></div></div></div></div>","q_nomatch":"<h2>Jobs</h2><div class=\"row\" style=\"gap:8px;margin-bottom:10px\"><button class=\"btn acc grow\" onclick=\"startWizard()\">✨ Guided Quote</button><button class=\"btn ghost grow\" onclick=\"if(typeof navSub==='function')navSub('leads')\">📞 Guided Lead</button></div><input class=\"search\" id=\"qsearch\" placeholder=\"Search jobs (customer, type, date)…\" value=\"zzznomatch\" oninput=\"qSearchOn(this.value)\"><div class=\"subnav\" style=\"margin:8px 0\"><button class=\"subbtn on\" onclick=\"quoteFilter('all')\">All</button><button class=\"subbtn \" onclick=\"quoteFilter('quote')\">Quote</button><button class=\"subbtn \" onclick=\"quoteFilter('job')\">Job</button><button class=\"subbtn \" onclick=\"quoteFilter('expense')\">Expense</button><button class=\"subbtn \" onclick=\"quoteFilter('invoice')\">Invoice</button><button class=\"subbtn \" onclick=\"quoteFilter('paid')\">Paid</button></div><button class=\"btn acc sm\" style=\"margin-bottom:10px\" onclick=\"qToggleHideDone()\">✅ Hiding 0 finished</button><select onchange=\"quoteCrewFilter(this.value)\" style=\"font-size:13px;margin-bottom:10px\"><option value=\"\" selected=\"\">👥 All crew</option><option value=\"u_g\">G</option></select><details class=\"card\" style=\"margin-bottom:10px\"><summary style=\"cursor:pointer;font-weight:700;user-select:none\">⚙️ Date range</summary><div class=\"row\" style=\"gap:8px;margin-top:8px\"><div class=\"grow\"><label>From</label><input type=\"date\" value=\"\" onchange=\"qDateFrom(this.value)\" style=\"width:100%\"></div><div class=\"grow\"><label>To</label><input type=\"date\" value=\"\" onchange=\"qDateTo(this.value)\" style=\"width:100%\"></div></div></details><div id=\"qlist\"><div class=\"empty\">No matches.</div></div>","c_empty":"<input class=\"search\" id=\"csearch\" placeholder=\"Search customers…\" value=\"\"><select aria-label=\"Sort customers\" onchange=\"cSetSort(this.value)\" style=\"font-size:13px;margin-bottom:10px\"><option value=\"name\" selected=\"\">Name A–Z</option><option value=\"namez\">Name Z–A</option><option value=\"recent\">Recently added</option></select><div class=\"empty\"><div class=\"big\">👥</div>No customers yet.<br>Tap + to add your first one.</div>","c_one":"<input class=\"search\" id=\"csearch\" placeholder=\"Search customers…\" value=\"\"><select aria-label=\"Sort customers\" onchange=\"cSetSort(this.value)\" style=\"font-size:13px;margin-bottom:10px\"><option value=\"name\" selected=\"\">Name A–Z</option><option value=\"namez\">Name Z–A</option><option value=\"recent\">Recently added</option></select><div class=\"card grid2\"><div class=\"li\" onclick=\"openCustomer('c1')\">\n    <div class=\"grow\"><div class=\"nm\">Alpha Cust</div>\n    <div class=\"sub\" style=\"white-space:normal\"><a href=\"tel:2525551212\" onclick=\"event.stopPropagation()\" style=\"color:var(--brand-text);text-decoration:underline\">📞 (252) 555-1212</a></div><div class=\"sub\" style=\"white-space:normal\">🏠 0 properties</div></div>\n    <span class=\"badge s-Lead\">Lead</span></div></div>","c_many":"<input class=\"search\" id=\"csearch\" placeholder=\"Search customers…\" value=\"\"><select aria-label=\"Sort customers\" onchange=\"cSetSort(this.value)\" style=\"font-size:13px;margin-bottom:10px\"><option value=\"name\" selected=\"\">Name A–Z</option><option value=\"namez\">Name Z–A</option><option value=\"recent\">Recently added</option></select><div class=\"card grid2\"><div class=\"li\" onclick=\"openCustomer('c1')\">\n    <div class=\"grow\"><div class=\"nm\">Alpha</div>\n    <div class=\"sub\" style=\"white-space:normal\"><a href=\"tel:2525551212\" onclick=\"event.stopPropagation()\" style=\"color:var(--brand-text);text-decoration:underline\">📞 (252) 555-1212</a></div><div class=\"sub\" style=\"white-space:normal\">🏠 0 properties</div></div>\n    <span class=\"badge s-Lead\">Lead</span></div><div class=\"li\" onclick=\"openCustomer('c2')\">\n    <div class=\"grow\"><div class=\"nm\">Beta</div>\n    <div class=\"sub\" style=\"white-space:normal\">BetaCo</div><div class=\"sub\" style=\"white-space:normal\">🏠 0 properties</div></div>\n    <span class=\"badge s-Lead\">Lead</span></div><div class=\"li\" onclick=\"openCustomer('c3')\">\n    <div class=\"grow\"><div class=\"nm\">Gamma</div>\n    <div class=\"sub\" style=\"white-space:normal\"><a href=\"mailto:g@x.com\" onclick=\"event.stopPropagation()\" style=\"color:var(--brand-text);text-decoration:underline\">✉️ g@x.com</a></div><div class=\"sub\" style=\"white-space:normal\">🏠 0 properties</div></div>\n    <span class=\"badge s-Lead\">Lead</span></div></div>","c_search":"<input class=\"search\" id=\"csearch\" placeholder=\"Search customers…\" value=\"alpha\"><select aria-label=\"Sort customers\" onchange=\"cSetSort(this.value)\" style=\"font-size:13px;margin-bottom:10px\"><option value=\"name\" selected=\"\">Name A–Z</option><option value=\"namez\">Name Z–A</option><option value=\"recent\">Recently added</option></select><div class=\"card grid2\"><div class=\"li\" onclick=\"openCustomer('c1')\">\n    <div class=\"grow\"><div class=\"nm\">Alpha</div>\n    <div class=\"sub\" style=\"white-space:normal\"><a href=\"tel:2525551212\" onclick=\"event.stopPropagation()\" style=\"color:var(--brand-text);text-decoration:underline\">📞 (252) 555-1212</a></div><div class=\"sub\" style=\"white-space:normal\">🏠 0 properties</div></div>\n    <span class=\"badge s-Lead\">Lead</span></div></div>","c_nomatch":"<input class=\"search\" id=\"csearch\" placeholder=\"Search customers…\" value=\"zzz\"><select aria-label=\"Sort customers\" onchange=\"cSetSort(this.value)\" style=\"font-size:13px;margin-bottom:10px\"><option value=\"name\" selected=\"\">Name A–Z</option><option value=\"namez\">Name Z–A</option><option value=\"recent\">Recently added</option></select><div class=\"empty\">No matches.</div>","p_empty":"<input class=\"search\" id=\"psearch\" placeholder=\"Search properties…\" value=\"\"><div class=\"empty\"><div class=\"big\">📍</div>No properties yet.<br>Add one, or they're created when you quote.</div>","p_one":"<input class=\"search\" id=\"psearch\" placeholder=\"Search properties…\" value=\"\"><div class=\"card grid2\"><div class=\"li\" onclick=\"openProperty('p1')\"><div class=\"grow\"><div class=\"nm\">Prop One</div><div class=\"sub\" style=\"white-space:normal\"><a href=\"https://maps.google.com/?q=1%20Main%20St\" target=\"_blank\" rel=\"noopener\" onclick=\"event.stopPropagation()\" style=\"color:var(--brand-text);text-decoration:underline\">1 Main St</a></div></div></div></div>","p_many":"<input class=\"search\" id=\"psearch\" placeholder=\"Search properties…\" value=\"\"><div class=\"card grid2\"><div class=\"li\" onclick=\"openProperty('p1')\"><div class=\"grow\"><div class=\"nm\">Prop One</div><div class=\"sub\" style=\"white-space:normal\"><a href=\"https://maps.google.com/?q=1%20Main%20St\" target=\"_blank\" rel=\"noopener\" onclick=\"event.stopPropagation()\" style=\"color:var(--brand-text);text-decoration:underline\">1 Main St</a></div></div></div><div class=\"li\" onclick=\"openProperty('p2')\"><div class=\"grow\"><div class=\"nm\">Prop Two</div><div class=\"sub\" style=\"white-space:normal\"><a href=\"https://maps.google.com/?q=2%20Oak%20Ave\" target=\"_blank\" rel=\"noopener\" onclick=\"event.stopPropagation()\" style=\"color:var(--brand-text);text-decoration:underline\">2 Oak Ave</a></div></div></div></div>","p_search":"<input class=\"search\" id=\"psearch\" placeholder=\"Search properties…\" value=\"oak\"><div class=\"card grid2\"><div class=\"li\" onclick=\"openProperty('p2')\"><div class=\"grow\"><div class=\"nm\">Prop Two</div><div class=\"sub\" style=\"white-space:normal\"><a href=\"https://maps.google.com/?q=2%20Oak%20Ave\" target=\"_blank\" rel=\"noopener\" onclick=\"event.stopPropagation()\" style=\"color:var(--brand-text);text-decoration:underline\">2 Oak Ave</a></div></div></div></div>","p_nomatch":"<input class=\"search\" id=\"psearch\" placeholder=\"Search properties…\" value=\"zzz\"><div class=\"empty\">No matches.</div>"};
...
// ================= QUOTES =================
// The Jobs list is now a sortable <table> (not a card grid), so the q_* goldens were RE-CAPTURED as the final
// post-rewrite #view and are compared DIRECTLY (no expected() transform — c_*/p_* still use it). The INVARIANT
// the test proves is unchanged: #qsearch lives OUTSIDE #qlist, the scoped #qlist rebuild == quotesListHTML(),
// and the caret survives. Reset the table's sort + Type/Date filter state so it matches the golden capture.
QSEARCH = ""; QSTAGE_SET = {}; QCREW_FILTER = "";
QSORT = "date"; QSORTDIR = "desc"; QDATE_FROM = ""; QDATE_TO = ""; QHIDE_DONE = true; QSHOWN = 150;
[["q_empty", [], [], [], []], ["q_one", C1, [], Q1, []], ["q_many", Cmany, [], Qmany, Jmany]].forEach(function (f) {
  setData(f[1], f[2], f[3], f[4]); rQuotes();
  eq(f[0] + " #view", view.innerHTML, GOLDEN[f[0]]);
  eq(f[0] + " scoped==inner", quotesListHTML(), innerOf(view.innerHTML, "qlist"));
});
QSEARCH = "alpha"; setData(Cmany, [], Qmany); rQuotes();
eq("q_search #view", view.innerHTML, GOLDEN["q_search"]);
eq("q_search scoped==inner", quotesListHTML(), innerOf(view.innerHTML, "qlist"));
QSEARCH = "zzznomatch"; setData(Cmany, [], Qmany); rQuotes();
eq("q_nomatch #view", view.innerHTML, GOLDEN["q_nomatch"]);
