...
function rcptParseSuggestion(text, cats, jobIds) {
  ...
  return { vendor: String(o.vendor || "").slice(0, 120), amount: amount, date: date,
    desc: String(o.desc || "").slice(0, 200), type: type, category: category, jobId: jobId, last4: last4, refund: refund, deposit: deposit, refNo: refNo, refType: refType, splits: splits, lineItems: lineItems, transactions: transactions, confidence: confidence };
}
