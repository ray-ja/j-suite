...
eq(R("junkMinFor(1)"),175,"solo min");eq(R("junkMinFor(2)"),300,"duo min");eq(R("junkMinFor(5)"),300,"caps at 2");eq(R("JUNK_CREW_MIN"),1,"stepper allows 1");
...
eq([R("junkPriceFor(calcJunk(),1)"),R("junkPriceFor(calcJunk(),2)")],[175,300],"close small: $175 / $300");
