...
eq([pj1,pj2],[225,300],"Joe: solo $225 / crew $300 (floor)");
// close small job
ctx.WZ.junk=[{key:"sofa",locs:{ground:1}},{key:"bag",locs:{ground:4}}];ctx.DRIVE={roundMiles:20,min:15};
eq([R("junkPriceFor(calcJunk(),1)"),R("junkPriceFor(calcJunk(),2)")],[225,300],"close small inside (ground): solo $225 / crew $300");
ctx.WZ.junk=[{key:"sofa",locs:{curbside:1}},{key:"bag",locs:{curbside:4}}];
eq([R("junkPriceFor(calcJunk(),1)"),R("junkPriceFor(calcJunk(),2)")],[175,300],"close small at the curb: $175 / $300");
